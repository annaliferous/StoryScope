...
export default function WelcomeDialog({
  ...
  return (
    ...
    >
      <DialogTitle id="alert-dialog-title"><img src="./storyScopeIcon.svg" alt="StoryScope Icon" width={40} style={{ verticalAlign: "middle", paddingRight: 8, paddingBottom:4 }}/> StoryScope</DialogTitle>
      <DialogContent>
